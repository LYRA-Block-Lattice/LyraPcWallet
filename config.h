...
#define RPC_MAINNET_IP_LIST                         {{"wss://161.97.166.188:5504/api/v1/socket", true}, \
                                                    {"wss://173.212.228.110:5504/api/v1/socket", true}, \
...
/* Info messages */
#define LOGIN_MANAGER_INFO_MESSAGE                  "Manager says:\npigs never die. they always get killed..."
#define CREATE_NEW_WALLET_MANAGER_INFO_MESSAGE      "Create new wallet says:\npigs never die. they always get killed..."
#define OPEN_WALLET_MANAGER_INFO_MESSAGE            "Open wallet says:\npigs never die. they always get killed..."
#define RESTORE_WALLET_MANAGER_INFO_MESSAGE         "Restore wallet says:\npigs never die. they always get killed..."
#define CREATE_USER_MANAGER_MANAGER_INFO_MESSAGE    "Create user manager says:\npigs never die. they always get killed..."
